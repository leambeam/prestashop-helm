...
Documentation can be found here: [Deploy custom PrestaShop Helm chart (internal repos)](https://wimma-capstone.pages.labranet.jamk.fi/support-material/3.%20OPS/reference-product-prestashop/Setup%20guides/Helm/helm-prestashop-deployment-internal-repos/)
